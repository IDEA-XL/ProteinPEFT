...
@register_model
class EsmMambaPPIModel(EsmMambaBaseModel):
    def __init__(self, **kwargs):
        """
        Args:
            **kwargs: other arguments for EsmMambaBaseModel
        """
    ...
    def forward(self, inputs_1, inputs_2):
        if self.freeze_backbone:
            ...
            hidden_1 = self.model.esm_mamba(**inputs_1)[0][:, 0, :]
            hidden_2 = self.model.esm_mamba(**inputs_2)[0][:, 0, :]
